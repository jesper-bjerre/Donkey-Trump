...
export function getControlCopy(touch = isTouchMode(), text = uiText) {
  ...
  if (touch) {
    return {
      ...
      instructionLines: [i.goal, ...text.touch.instructions, i.ladderNote, i.privacy],
  ...
  return {
    ...
    instructionLines: [i.goal, i.left, i.right, i.jump, i.up, i.down, i.pause, i.resume, i.retry, i.mute, i.ladderNote, i.privacy],
